...
const onmousemove = (e: React.MouseEvent<Element, MouseEvent>) : void => {
    ...
    drawInteractionLayer(x,y, e.clientX, e.clientY);
}
...
export default function Home() {
    ...
    return (
        <div className={`w-[${graphConfig.size.width}px] h-[${graphConfig.size.height}px] relative`}>
            ...
            <canvas ref={canvasOverlayRef} width={graphConfig.size.width} height={graphConfig.size.height}
                    className={'canvas-item'} onMouseMove={onmousemove}></canvas>
        </div>
    );
}
